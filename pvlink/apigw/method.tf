...
# # Deploy the API
# resource "aws_api_gateway_deployment" "petstore" {
#   depends_on = [
#     aws_api_gateway_integration.root_get_integration,
#     aws_api_gateway_integration.pets_get_integration,
#     aws_api_gateway_integration.pets_post_integration,
#     aws_api_gateway_integration.pets_options_integration,
#     aws_api_gateway_integration.pet_get_integration,
#     aws_api_gateway_integration.pet_options_integration
#   ]
...
# # Output the base URL of the API
# output "api_url" {
#   value = "${aws_api_gateway_deployment.petstore.invoke_url}"
# }